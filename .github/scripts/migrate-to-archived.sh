...
#      （取得方法: gh api graphql -f query='{ user(login: "yyamamoto95") { projectV2(number: 1) {
...
SPRINT_NUM_FIELD_ID="PVTF_lAHOA-qlQM4BWtuozhSdS10"
...
""".replace("$PROJECT_ID", "PVT_kwHOA-qlQM4BWtuo") \
   .replace("$ITEM_ID", item_id) \
   .replace("$FIELD_ID", "PVTSSF_lAHOA-qlQM4BWtuozhR_pd4") \
