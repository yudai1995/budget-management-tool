...
export const EXPENSE_CATEGORY_TOKENS: Record<string, CategoryToken> = {
  ...
  food:         { key: 'food',         name: '食費',    color: '#d97030', bg: '#fef5ee', icon: ShoppingBasket },
  dining:       { key: 'dining',       name: '外食',    color: '#c85220', bg: '#fef2ee', icon: Utensils       },
  transport:    { key: 'transport',    name: '交通費',  color: '#2c72e4', bg: '#eff6ff', icon: Car            },
  utility:      { key: 'utility',      name: '光熱費',  color: '#9e4808', bg: '#fffbeb', icon: Zap            },
  telecom:      { key: 'telecom',      name: '通信費',  color: '#1e40af', bg: '#eff6ff', icon: Smartphone     },
  housing:      { key: 'housing',      name: '住宅費',  color: '#7c2d12', bg: '#fff7ed', icon: Building2      },
  tax:          { key: 'tax',          name: '税金',    color: '#1f2937', bg: '#f9fafb', icon: Landmark       },
  medical:      { key: 'medical',      name: '医療費',  color: '#d8284a', bg: '#fff1f2', icon: Heart          },
  insurance:    { key: 'insurance',    name: '保険',    color: '#cc3082', bg: '#fdf2f8', icon: Shield         },
  daily:        { key: 'daily',        name: '日用品',  color: '#0c90cc', bg: '#f0f9ff', icon: ShoppingBag    },
  education:    { key: 'education',    name: '教育費',  color: '#d88908', bg: '#fffbeb', icon: GraduationCap  },
  beauty:       { key: 'beauty',       name: '美容費',  color: '#bc30d4', bg: '#fdf4ff', icon: Scissors       },
  clothing:     { key: 'clothing',     name: '衣類',    color: '#5052d8', bg: '#eef2ff', icon: Shirt          },
  leisure:      { key: 'leisure',      name: '趣味',    color: '#7448e0', bg: '#f5f3ff', icon: Music          },
