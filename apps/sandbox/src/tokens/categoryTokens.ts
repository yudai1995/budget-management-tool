...
export const EXPENSE_CATEGORY_TOKENS: Record<string, CategoryToken> = {
  ...
  dining:       { key: 'dining',       name: '外食',    color: '#e8622a', bg: '#fef2ee', icon: Utensils       },
  transport:    { key: 'transport',    name: '交通費',  color: '#3b82f6', bg: '#eff6ff', icon: Car            },
  utility:      { key: 'utility',      name: '光熱費',  color: '#b45309', bg: '#fffbeb', icon: Zap            },
  ...
  education:    { key: 'education',    name: '教育費',  color: '#f59e0b', bg: '#fffbeb', icon: GraduationCap  },
...
export const INCOME_CATEGORY_TOKENS: Record<string, CategoryToken> = {
  ...
  sideJob:      { key: 'sideJob',      name: '副業',        color: '#16a34a', bg: '#dcfce7', icon: Briefcase        },
  benefit:      { key: 'benefit',      name: '手当',        color: '#0891b2', bg: '#ecfeff', icon: Wallet           },
  pension:      { key: 'pension',      name: '年金',        color: '#0f766e', bg: '#f0fdfa', icon: Users            },
  investment:   { key: 'investment',   name: '投資・配当',  color: '#10b981', bg: '#f0fdf4', icon: TrendingUp       },
  other:        { key: 'other',        name: 'その他',      color: '#94a3b8', bg: '#f8fafc', icon: Tag              },
}
